...
return new class () extends Migration {
    public function up(): void
    {
        ...
        Schema::create('mailcoach_email_lists', function (Blueprint $table): void {
            $table->id();
        ...
        Schema::create('mailcoach_subscribers', function (Blueprint $table): void {
            $table->id();
            $table->uuid('uuid')->unique();
        ...
        Schema::create('mailcoach_segments', function (Blueprint $table): void {
            $table->id();
            $table->uuid('uuid')->unique();
            $table->string('name');
            $table
        ...
        Schema::create('mailcoach_campaigns', function (Blueprint $table): void {
            $table->id();
            $table->uuid('uuid')->unique();
        ...
        Schema::create('mailcoach_transactional_mail_log_items', function (Blueprint $table): void {
            $table->id();
            $table->uuid('uuid')->unique();
        ...
        Schema::create('mailcoach_automation_mails', function (Blueprint $table): void {
            $table->id();
            $table->uuid('uuid')->unique();
            $table->string('name')->nullable();
        ...
        Schema::create('mailcoach_sends', function (Blueprint $table): void {
            $table->id();
            $table->uuid('uuid')->unique();
        ...
        Schema::create('mailcoach_send_feedback_items', function (Blueprint $table): void {
            $table->id();
            $table->uuid('uuid')->unique();
            $table->string('type');
        ...
        Schema::create('mailcoach_templates', function (Blueprint $table): void {
            $table->id();
            $table->uuid('uuid')->unique();
            $table->string('name');
        ...
        Schema::create('mailcoach_subscriber_imports', function (Blueprint $table): void {
            $table->id();
            $table->uuid('uuid')->unique();
        ...
        Schema::create('mailcoach_tags', function (Blueprint $table): void {
            $table->id();
            $table->uuid('uuid')->unique();
            $table->string('name');
        ...
        Schema::create('mailcoach_email_list_subscriber_tags', function (Blueprint $table): void {
            $table->id();
        ...
        Schema::create('mailcoach_email_list_allow_form_subscription_tags', function (Blueprint $table): void {
            $table->id();
        ...
        Schema::create('mailcoach_automations', function (Blueprint $table): void {
            $table->id();
            $table->uuid('uuid')->unique();
        ...
        Schema::create('mailcoach_automation_actions', function (Blueprint $table): void {
            $table->id();
            $table->uuid('uuid')->unique();
        ...
        Schema::create('mailcoach_automation_triggers', function (Blueprint $table): void {
            $table->id();
            $table->uuid('uuid')->unique();
        ...
        Schema::create('mailcoach_automation_action_subscriber', function (Blueprint $table): void {
            $table->id();
            $table->uuid('uuid')->unique();
        ...
        Schema::create('mailcoach_transactional_mails', function (Blueprint $table): void {
            $table->id();
            $table->uuid('uuid')->unique();
        ...
        Schema::create('mailcoach_uploads', function (Blueprint $table): void {
            $table->bigIncrements('id');
            $table->uuid('uuid')->unique();
            $table->timestamps();
        });
        ...
        Schema::create('mailcoach_settings', function (Blueprint $table): void {
            $table->string('key')->index();
            $table->longText('value')->nullable();
        });

        Schema::create('mailcoach_mailers', function (Blueprint $table): void {
            $table->id();
            $table->uuid()->unique();
            $table->string('name');
        ...
        Schema::create('mailcoach_webhook_configurations', function (Blueprint $table): void {
            $table->id();
        ...
        Schema::create('mailcoach_webhook_configuration_email_lists', function (Blueprint $table): void {
            $table->id();
        ...
        Schema::create('mailcoach_webhook_logs', function (Blueprint $table): void {
            $table->id();
            $table->uuid('uuid')->unique();
            $table->unsignedBigInteger('webhook_configuration_id');
