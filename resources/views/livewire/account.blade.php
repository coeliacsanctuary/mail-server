<div class="card-grid">
    ...
    >
        ...
        <x-mailcoach::fieldset card :legend="__mc('Profile')">
            <x-mailcoach::text-field :label="__mc('Email')" name="email" type="email" wire:model.live="email" required />
    ...
    >
        ...
        <x-mailcoach::fieldset :legend="__mc('Password')" card>
            <x-mailcoach::text-field :label="__mc('Current password')" name="current_password" type="password" wire:model.live="current_password"  required />
            <x-mailcoach::text-field :label="__mc('New password')" name="password" type="password" wire:model.live="password" required />
            <x-mailcoach::text-field :label="__mc('Confirm new password')" name="password_confirmation" wire:model.live="password_confirmation" type="password" required />
